...
Route::middleware(['auth', 'role:admin'])->group(function () {
	...
	Route::get('/orders/manage/diambil', [OrderController::class, 'manageDiambil'])->name('orders.manage.diambil');
    ...
    // routes/web.php
	Route::post('/orders/{id}/diambil', [OrderController::class, 'markAsDiambil'])->name('orders.selesai');
